...
public class DisplayRoute extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Sets the text title at the top of the activity to display where the route is going from and to
        ...
        //Puts the elements of the array adapter into a list view to display the route to the user
